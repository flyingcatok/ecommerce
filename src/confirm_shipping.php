...
// 		$shopdate = $row["ShopDate"];
        ...
        if (isset($_POST["shipmethod"]) && ($_POST["shipmethod"] != "default")) {
            if ($_POST["shipmethod"] == "overnight") {
                $shiptotal = $subtotal + 20;
                echo "<tr><th colspan=5>Total (Overnight Shipping): \$ $shiptotal</th></tr>";
                $shipMethod = "One-Day Overnight";
            }
            else if ($_POST["shipmethod"] == "twoday") {
                $shiptotal = $subtotal + 10;
                echo "<tr><th colspan=5>Total (Two-Day Express Shipping): \$ $shiptotal</th></tr>";
                $shipMethod = "Two-Day Express";
            }
            else {
                $shiptotal = $subtotal + 5;
                echo "<tr><th colspan=5>Total (Standard Ground Shipping): \$ $shiptotal</th></tr>";
                $shipMethod = "Regular";
            }
...
<?php
        ...
        <div id ="cards" style ="background-color:#FFFFFF; clear:both; text-align:left">
           ...
           ?>
            <br> <br><br>
            <input type="hidden" name ="method" value="<?php echo $shipMethod?>" >
